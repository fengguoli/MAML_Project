...
train_file_name_a = ['./data/train_oneshot_a_w_ngb.tfrecord', './data/train_oneshot_b_w_ngb.tfrecord'] #, pre+'train_oneshot_c_w_ngb'+suf]
train_file_name_b = ['./data/train_oneshot_b_w_ngb.tfrecord', './data/train_oneshot_c_w_ngb.tfrecord'] #, pre+'train_oneshot_a_w_ngb'+suf]

# warm, warm_2 - used for warm-up training
train_file_name_warm = ['./data/test_oneshot_a.tfrecord']
train_file_name_warm_2 = ['./data/test_oneshot_b.tfrecord']

# you can use 'test_oneshot_a_w_ngb' for validation
test_file_name = ['./data/test_test_w_ngb.tfrecord']
